...
class Road:
    ...
    def __init__(self, _weight, _centimeter):
        self.weight = _weight  # Масса асвальта
        self.centimeter = _centimeter  # толщина в сантиметрах

    def sum_road(self):
        return self.centimeter * self.weight * self._width * (self._length / 100)  # переводим сантиметры в метры


cm = int(input('Толщина покрытия в (см): '))
we = int(input('Масса асфальта: '))
r = Road(cm, we)
print(r.sum_road())
